...
(function(e){if(require("./polyfills"),exports.generate=require("./generator").generate,exports.ajax=require("./ajax"),exports.load=require("./load"),e.browser)exports.version="0.0.2",exports.homepage=",";else{var r=require("../package.json");exports.version=r.version,exports.homepage=r.homepage}}).call(this,require("_process"));
